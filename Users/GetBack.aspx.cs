...
public partial class Users_GetBack : System.Web.UI.Page
{
                    ...
                    if (result > 0)
                    {
                        ...
                        if (result > clientAmount)
                        {
                            ...
                            if (i == 1)
                            {
                                ...
                                new LectureCode().UpdateLectureBuy(refrenceNumber, reservationNumber);
                                UpdatePrintPanel();
                            }
                            else
                            {
    ...
    {
        DataSet ds = new LectureCode().GetLectureLectureBuy(reservationNumber);
    ...
    {
        return double.Parse(Session["LecturePrice"].ToString());
        ////////////////////////////////////////////////////
        /// Atrtention                  توجه !
