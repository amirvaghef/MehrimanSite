...
public partial class Users_GetBackTranslation : System.Web.UI.Page
{
                    ...
                    if (result > 0)
                    {
                        ...
                        if (result > clientAmount)
                        {
                            ...
                            if (i == 1)
                            {
                                ...
                                new TranslationCode().UpdatePaid(reservationNumber, refrenceNumber);
                            }
                            else
                            {
    ...
    {
        return double.Parse(Session["TransPrice"].ToString());
        ////////////////////////////////////////////////////
        /// Atrtention                  توجه !
