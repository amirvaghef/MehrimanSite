<%@ Page Title="انتشارات مهرایمان:: تأئید پرداخت::ناشر تخصصی معماری و شهرسازی" Language="C#"
    MasterPageFile="~/Masters/MPUsersDefault.master" AutoEventWireup="true" CodeFile="GetBackDownload.aspx.cs"
    Inherits="Users_GetBackDownload" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="background-image: url('../Images/ContentBG.gif');
        ...
        <tr>
            <td align="center">
                <a id="linkDownload" runat="server" visible="false" href="">
                    <img src="../Images/print.GIF" alt="دانلود" />
                </a>
            </td>
            <td>
                <asp:ImageButton ID="imbBack" ImageUrl="~/Images/back.GIF" runat="server" PostBackUrl="~/../Download.aspx" />
            </td>
        </tr>
    </table>
</asp:Content>
