<%@ Page Title="انتشارات مهرایمان:: تأئید پرداخت::ناشر تخصصی معماری و شهرسازی" Language="C#"
    MasterPageFile="~/Masters/MPUsersDefault.master" AutoEventWireup="true" CodeFile="GetBackFree.aspx.cs"
    Inherits="Users_GetBackFree" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="background-image: url('../Images/ContentBG.gif');
        ...
        <tr>
            ...
            <td>
                <asp:ImageButton ID="imbPrint" ImageUrl="~/Images/print.GIF" runat="server" OnClick="imbPrint_Click" />
            </td>
        </tr>
    </table>
</asp:Content>
