<%@ Page Title="انتشارات مهرایمان:: پرداخت آنلاین::ناشر تخصصی معماری و شهرسازی" Language="C#"
    MasterPageFile="~/Masters/MPPaymentDefault.master" AutoEventWireup="true" CodeFile="SendTranslation.aspx.cs"
    Inherits="Users_SendTranslation" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td align="center" colspan="2" style="background-image: url('../Images/TranslationGuide.gif');
                ...
                <b>لطفاً پس از واریز مبلغ ترجمه شناسه های پرداخت را یادداشت نمائید.
                    <br />
