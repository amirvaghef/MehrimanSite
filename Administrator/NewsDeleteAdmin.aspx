<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsDeleteAdmin.aspx.cs" Inherits="Administrator_NewsDeleteAdmin" %>
                                        ...
                                        <td>
                                            <asp:GridView ID="gwNews" runat="server" AllowPaging="True" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="ArchiveDate" HeaderText="تاریخ آرشیو" />
                                                    <asp:CheckBoxField DataField="NewsFirstPage" HeaderText="درج در صفحه اول" />
                                                    <asp:BoundField DataField="NewsCategoryName" HeaderText="دسته بندی خبر" 
                                                        SortExpression="NewsCategoryName" />
                                                </Columns>
