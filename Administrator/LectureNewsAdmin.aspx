<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LectureNewsAdmin.aspx.cs" Inherits="Administrator_LectureNewsAdmin"
     ...
     filebrowserFlashUploadUrl: '../ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload&type=Flash'
            ...
            <tr>
                <td style="width: 1027px; height: 25px; background-color: White;">
                    <a href="LectureNewsDeleteAdmin.aspx">حذف و تغییر اخبار</a>
                </td>
            </tr>
