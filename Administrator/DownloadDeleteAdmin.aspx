<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DownloadDeleteAdmin.aspx.cs" Inherits="Administrator_DownloadDeleteAdmin" %>
                        ...
                        <tr>
                            <td valign="top" style="background-image: url('../Images/MainBGDownload.jpg'); width: 1027px;
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <asp:GridView ID="gwDownloads" runat="server" AllowPaging="True" 
                                                AutoGenerateColumns="False" AutoGenerateDeleteButton="True" 
                                                BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" 
                                                CellPadding="2" EnableModelValidation="True" 
                                                ForeColor="Black" GridLines="None" onrowdeleting="gwDownloads_RowDeleting" 
                                                PageSize="15" onpageindexchanging="gwDownloads_PageIndexChanging">
                                                <AlternatingRowStyle BackColor="PaleGoldenrod" />
                                                <Columns>
                                                    <asp:BoundField DataField="DownloadID" HeaderText="شماره دانلود" />
                                                    <asp:BoundField DataField="DownloadName" HeaderText="نام فایل" />
                                                    <asp:BoundField DataField="DownloadSize" HeaderText="سایز فایل" />
                                                    <asp:BoundField DataField="DownloadProfileName" HeaderText="دسته بندی" 
                                                        SortExpression="DownloadProfileName" />
                                                </Columns>
