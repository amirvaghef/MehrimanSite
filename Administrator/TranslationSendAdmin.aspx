<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TranslationSendAdmin.aspx.cs"
    Inherits="Administrator_TranslationSendAdmin" ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <script type="text/javascript" src="../ckeditor/ckeditor.js"></script>
    <title>انتشارات مهرایمان:: درخواست ترجمه</title>
</head>
                                                    ...
                                                    CKEDITOR.replace('editor1',
 {
     ...
     filebrowserFlashUploadUrl: '../ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload&type=Flash'
			...
			//]]>
                                                ...
                                                <br />
                                                فایل ترجمه:
                                                <asp:FileUpload ID="inpAttachment1" runat="server" />
                                            </asp:Panel>
                                        </td>
                                    </tr>
                                    <tr>
