<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GalleryDeleteAdmin.aspx.cs" Inherits="Administrator_GalleryDeleteAdmin" %>
            ...
            <tr style="height: 246px; width: 1027px; background-image: url('../images/HeaderBGGallery.jpg');">
                <td align="right">
                    ...
                    <table width="1027" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="background-image: url('../Images/HeaderRightGallery.gif'); width: 295px; height: 246px;">
                            </td>
                            <td style="background-image: url('../Images/HeaderLeftGallery.gif'); width: 732px; height: 246px;">
                            </td>
                        </tr>
                    </table>
                </td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            ...
                                            <asp:GridView ID="gwImages" runat="server" AllowPaging="True" 
                                                AutoGenerateColumns="False" AutoGenerateDeleteButton="True" 
                                                BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" 
                                                CellPadding="2" EnableModelValidation="True" 
                                                ForeColor="Black" GridLines="None" onrowdeleting="gwImages_RowDeleting" 
                                                PageSize="5" onpageindexchanging="gwImages_PageIndexChanging">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:ImageField DataImageUrlField="ImageSource" 
                                                        DataImageUrlFormatString="../../Images/Gallery/Thumb/{0}" HeaderText="تصویر">
                                                    </asp:ImageField>
                                                    <asp:BoundField DataField="ImageProfileName" HeaderText="دسته بندی" />
                                                </Columns>
