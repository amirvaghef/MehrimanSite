<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsAdmin.aspx.cs" Inherits="Administrator_NewsAdmin"
                                                ...
                                                CKEDITOR.replace('editor2',
 {
     ...
     filebrowserFlashUploadUrl: '../ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload&type=Flash'
			...
			//]]>
                                    ...
                                    <tr>
                                        <td valign="top" align="right" style="color:White;">
                                            آیا در صفحه اول نمایش داده شود؟:
                                            <asp:CheckBox ID="chbfirstPage" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
            ...
            <tr>
                <td style="width: 1027px; height: 25px; background-color: White;">
                    <a href="NewsDeleteAdmin.aspx">حذف و تغییر اخبار</a>
                </td>
            </tr>
