<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommentSubmitAdmin.aspx.cs" Inherits="Administrator_CommentSubmitAdmin" %>
                        ...
                        <tr align="right">
                            <td colspan="2">
                                <asp:GridView ID="grdComments" runat="server" AllowPaging="True" 
                                    ...
                                    CellPadding="2" DataKeyNames="CommentsID"
                                    ForeColor="Black" GridLines="None" onrowdeleting="grdComments_RowDeleting"
                                     PageSize="15" onpageindexchanging="grdComments_PageIndexChanging" 
                                    Width="100%" onrowcommand="grdComments_RowCommand">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonField CommandName="Submit" Text="تأئید"/>
